$(document).ready(function(){
	...
	$("#firstname3").focusout(function(){
            ...
            if($(this).val()==''){
                    ...
                    $('#laborupdate').attr('disabled',true);
            ...
            else
            {
	                ...
	                $('#laborupdate').attr('disabled',false);
	...
	$("#about3").focusout(function(){
           	...
           	if(!$about.match(about))
            {
            	    $(this).css("border-color", "#FF0000");
                    $('#laborupdate').attr('disabled',true);
                    $("#error_about3").text("* Please enter valid character not a digit ");           	
            }
            else
            {
	            	$(this).css("border-color", "#2eb82e");
	...
	$("#location3").focusout(function(){
		 	var location3=/^[a-zA-Z]+$/;
            $location3=$("#location3").val();
            
            if(!$location3.match(location3))
            {
            	    $(this).css("border-color", "#FF0000");
                    $('#laborupdate').attr('disabled',true);
