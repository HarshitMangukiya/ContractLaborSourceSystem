				...
				<div class="container">
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.php">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="#">Customer Details</a></p>
						</div>											
					</div>
				</div>
			</section>
...
<!-- 									<li>
									...
									<li>
										...
										<span>Country: 
												<?php
									    	    $qry3="select * from country where id='$row[7]'"; 
									...
									<li>
										...
										<span>State: 
											<?php
									    	    $qry3="select * from state where s_id='$row[8]'"; 
											    $res3=mysqli_query($con,$qry3);
												while($row3=mysqli_fetch_row($res3))
										        {
										        	echo $row3[1];
									...
									<li>
										...
										<span>City:
										 	<?php
									    	    $qry3="select * from city where ci_id='$row[9]'"; 
											    $res3=mysqli_query($con,$qry3);
												while($row3=mysqli_fetch_row($res3))
										        {
										        	echo $row3[1];
