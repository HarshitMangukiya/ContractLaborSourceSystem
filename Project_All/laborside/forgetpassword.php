...
<!--       <section class="banner-area relative" id="home">  
 ...
 -->      <!-- End banner Area -->  
  ...
  <?php
        ...
        {
           $email3=$_POST['emailforget'];
           $qry="select * from labor where l_email='$email3' and l_dflag<>'1'";    
             ...
             if($res=mysqli_query($con,$qry))
            {
              if(mysqli_num_rows($res)==1)
              {
                ...
                $emailforget=$_POST['emailforget'];
                  ...
                  unset($_SESSION['laboremail']);

                  $_SESSION['laboremail']=$row[0];
                        ...
                        $email =$emailforget;
                        $subject = 'OTP';
                        $body = 'OTP :-'.$_SESSION['code'].' Enter this otp in website';
...
<br>
    ...
    <form class="text-center" style="color:#757575;" method="post" enctype="multipart/form-data"> -->
      ...
      <br>
      <strong>Email *
    <input type="email" id="emailforget" class="form-control mb-4" name="emailforget" placeholder="Enter Your Email" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Your Email '"></storng>
    <span id="error_emailforget" class="text-danger"></span>



      <!-- Sign in button -->
      <button class="btn btn-outline-info btn-rounded btn-block my-4 waves-effect z-depth-0" type="submit" name="forget" id="forget">Send OTP</button>
      ...
      ?>
       ...
       <p align="left">OTP *
    <input type="text" class="form-control mb-4" placeholder="Enter OTP" id="otp" name="otp" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter OTP '"></p>
    <span id="error_otp" class="text-danger"></span>

      <button class="btn btn-outline-info btn-rounded btn-block my-4 waves-effect z-depth-0" type="submit" name="submit2" id="submit2">Submit</button>
