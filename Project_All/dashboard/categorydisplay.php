										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
													<p class="small">Category Detail</p>
													<form>
														<div class="row">
															<div class="col-sm-12">
												...
												while($row=mysqli_fetch_row($res))
													...
													<td>
														<div class="form-button-action">
															<a href="categoryedit.php?caid=<?php echo $row[0]; ?>" class="btn btn-link btn-primary btn-lg">		
																<i class="fa fa-edit"></i>
															</a>
														</div></td>						
													<td>
														<div class="form-button-action">
														<a href="categorydisplay.php?caid=<?php echo $row[0]; ?>" class="btn btn-link btn-danger">	
