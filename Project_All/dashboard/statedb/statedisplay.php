							...
							<div class="card">
								<div class="card-header">
									<!-- <div class="d-flex align-items-center"> -->
										<h4 class="card-title">State Information</h4>
												...
												while($row=mysqli_fetch_row($res))
													{
														if(!empty($row[2]))
														{
														$qry1="select * from country where id=".$row[2];
...
<!-- 													<td><?php echo $row[4];?></td>
													...
													<td>
														<div class="form-button-action">
															<a href="stateedit.php?sid=<?php echo $row[0]; ?>" class="btn btn-link btn-primary btn-lg">		
																<i class="fa fa-edit"></i>
															</a>
														</div></td>						
													<td>
														<div class="form-button-action">
														<a href="statedisplay.php?sid=<?php echo $row[0]; ?>" class="btn btn-link btn-danger">	
