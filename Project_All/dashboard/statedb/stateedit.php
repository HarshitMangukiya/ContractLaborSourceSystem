									...
									<li>
										...
										<div class="collapse show" id="subnav5">
											<ul class="nav nav-collapse subnav">
												...
												<li class="active">
													<a href="#">
														<span class="sub-item">Update State Detail</span>
													</a>
												</li>
											</ul>
										</div>
										...
										<div class="row">
											<div class="col-md-6 col-lg-4">
												...
												<div class="form-group">
													...
													<input type="text" class="form-control" id="firstname3" name="firstname" placeholder="Enter State name " value="<?php echo $firstname;?>" >
...
<!-- 
 ...
 -->
	...
	<script src="../labor/statevalidate.js"></script>
