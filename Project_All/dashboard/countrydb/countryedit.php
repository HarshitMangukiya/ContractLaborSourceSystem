...
<!-- 									<li>
 ...
 -->									<li>
							...
							<div class="collapse show" id="submenu">
								<ul class="nav nav-collapse">
									...
									<li>
										...
										<div class="collapse show" id="subnav4">
											<ul class="nav nav-collapse subnav">
												<li>
													<a href="countryinsert.php">
														<span class="sub-item">Add New Country</span>
													</a>
												</li>
												<li>
													<a href="countrydisplay.php">
														<span class="sub-item">Edit Country Detail</span>
													</a>
												</li>
												<li class="active">
													<a href="#">
														<span class="sub-item">Update Country Detail</span>
													</a>
												</li>
											</ul>
										</div>
			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Update Country Name</h4>
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="#">Update Country Detail</a>
							</li>
						</ul>
					</div>
	...
	if(isset($_REQUEST['cid']))
	{
        ...
        $qry="select * from country where id=".$_REQUEST['cid'];
        $res=mysqli_query($con,$qry);
        while($row=mysqli_fetch_row($res))
        {
         $firstname=$row[1];
	...
	if(isset($_POST['update']))
    {
	  ...
	  $name=ucfirst($_POST['firstname']);
    
      $qry="update country set name='$name' where id=".$_REQUEST['cid'];
      // echo $qry;
      // die();
      $res=mysqli_query($con,$qry);
        if($res>0)
										...
										<div class="row">
											<div class="col-md-6 col-lg-4">
												...
												<div class="form-group">
													...
													<input type="text" class="form-control" id="firstname3" name="firstname" placeholder="Enter Country name " value="<?php echo $firstname;?>" >
