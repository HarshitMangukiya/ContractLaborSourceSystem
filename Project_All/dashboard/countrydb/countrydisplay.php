									...
									<div class="table-responsive">
										<table id="add-row" class="display table table-striped table-hover" >
											...
											<?php	
												...
												{
													$qry="delete from country where id=".$_REQUEST['cid'];
													// echo $qry;
													// die();
													$res=mysqli_query($con,$qry);
													if($res==1)
...
<!-- 													<td><?php echo $row[4];?></td>
													...
													<td>
														<div class="form-button-action">
															<a href="countryedit.php?cid=<?php echo $row[0]; ?>" class="btn btn-link btn-primary btn-lg">		
																<i class="fa fa-edit"></i>
															</a>
														</div></td>						
													<td>
														<div class="form-button-action">
														<a href="countrydisplay.php?cid=<?php echo $row[0]; ?>" class="btn btn-link btn-danger">	
