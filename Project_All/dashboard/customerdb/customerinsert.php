 ...
 -->
	...
	if(isset($_POST['insert']))
	{
      ...
      if($_FILES["fimage"]["name"]!=null)
      {
        ...
        if($flag==1)
        {
       $qry="insert into customer(c_id,c_firstname,c_lastname,c_email,c_phone,c_address,c_location,c_country,c_state,c_city,c_pincode,c_password,c_about,c_date) values(0,'$firstname','$lastname','$email','$phone','$address','$location','$country','$state','$city','$pincode','$password','$about',NOW());";
      // echo $qry;
      // die();
      		$flag=0;
  		}
       ...
       $qry="insert into customer(c_id,c_firstname,c_lastname,c_email,c_phone,c_address,c_location,c_country,c_state,c_city,c_pincode,c_password,c_about,c_image,c_date) values(0,'$firstname','$lastname','$email','$phone','$address','$location','$country','$state','$city','$pincode','$password','$about','$myimg',NOW());";
...
<!-- 												<div class="form-group">
 ...
 -->
	...
	<script src="../labor/customervalidate.js"></script>
