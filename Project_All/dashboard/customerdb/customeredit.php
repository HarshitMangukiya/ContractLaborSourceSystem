					...
					<div class="user">
						...
						<div class="info">
							<a data-toggle="collapse" href="#collapseExample" aria-expanded="true">
								<span>
									 <?php echo $name;?>									<span class="user-level">Administrator</span>
...
<!-- 									<li>
									...
									<li>
										...
										<div class="collapse show" id="subnav3">
											<ul class="nav nav-collapse subnav">
												...
												<li class="active">
													<a href="#">
														<span class="sub-item">Update Customer Detail</span>
													</a>
												</li>
											</ul>
										</div>
			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Update Customer Information</h4>
	...
	if(isset($_POST['update']))
    {
		      ...
		      $flag='';
			    ...
			    if($flag==1)
			    {
			      $qry="update customer set c_firstname='$firstname',c_lastname='$lastname',c_email='$email',c_phone='$phone',c_address='$address',c_location='$location',c_country='$country',c_state='$state',c_city='$city',c_pincode='$pincode',c_password='$password',c_about='$about' where c_id=".$_REQUEST['cuid'];
			      // echo $qry;
			      // die();
			      $flag=0;
			    }
			    else
			    {
			      ...
			      $qry="update customer set c_firstname='$firstname',c_lastname='$lastname',c_email='$email',c_phone='$phone',c_address='$address',c_location='$location',c_country='$country',c_state='$state',c_city='$city',c_pincode='$pincode',c_password='$password',c_about='$about',c_image='$myimg' where c_id=".$_REQUEST['cuid'];
			      // echo $qry;
			      // die();
			    }
										...
										<div class="row">
											<div class="col-md-6 col-lg-4">
												...
												<div class="form-group">
													...
													<input type="text" class="form-control" id="firstname3" name="firstname" placeholder="Enter First name " value="<?php echo $firstname;?>" >
												    <span id="error_firstname3" class="text-danger"></span>
												</div>

												<div class="form-group">
													<label for="password">Last Name: </label>
													<input type="text" class="form-control" id="lastname3" name="lastname" placeholder="Enter Last name "  value="<?php echo $lastname;?>">
...
<!-- 												<div class="form-group">
												...
												<div class="form-group">
													...
													<input type="text" class="form-control" id="age3" name="age" placeholder="Enter Age " value="<?php echo $age;?>">
 ...
 -->
												<div class="form-group">
													...
													<input type="text" class="form-control" id="email3" name="email" placeholder="Enter email " value="<?php echo $email;?>">
												...
												<div class="form-group">
													...
													<input type="text" class="form-control" id="phone3" name="phone" placeholder="Enter Contact Number " value="<?php echo $phone;?>">
...
<!-- 												<div class="form-group">
													...
													<input type="text" class="form-control" id="aadharno3" name="aadharno" placeholder="Enter Aadhar Number " value="<?php echo $aadharno;?>">
												    <span id="error_aadharno3" class="text-danger"></span>
												</div>
 -->
												<div class="form-group">
													<label for="password">Address: </label>
													<input type="text" class="form-control" id="address3" name="address" placeholder="Enter Address " value="<?php echo $address;?>">
												...
												<div class="form-group">
													...
													<input type="text" class="form-control" id="location3"
													 name="location" placeholder="Enter Location " value="<?php echo $location;?>">
 ...
 -->
												<div class="form-group">
													...
													<input type="text" class="form-control" id="pincode3"
													 name="pincode" placeholder="Enter Pincode " value="<?php echo $pincode;?>">
												    <span id="error_pincode3" class="text-danger"></span>
												</div>
<!-- 
												<div class="form-group">
													<label for="password">Status: </label>        
												<input type="radio" name="status" id="available1" value="available" 
												<?php if (isset($status) && $status=="available") echo "checked";?>> available     
												<input type="radio" name="status" id="unavailable1" value="unavailable" 
												<?php if (isset($status) && $status=="unavailable") echo "checked";?>> unavailable
												    <span id="error_status3" class="text-danger"></span>
												 </div>
 -->
												<div class="form-group">
													<label for="password">About Customer: </label>
													<input type="text" class="form-control" id="about3"
													 name="about" placeholder="Enter Location " value="<?php echo $about;?>">
...
<!-- 
												<div class="form-group">
													...
													<input type="text" class="form-control" id="charge3"
													 name="charge" placeholder="Enter Charge " value="<?php echo $charge;?>">
 ...
 -->
												...
												<div class="form-group">
													...
													<input type="text" class="form-control" id="password3"
													 name="password" placeholder="Enter Password " value="<?php echo $password;?>">
									...
									<div class="card-action">
										<button class="btn btn-success" type="submit" id="signup3" name="update">Submit</button>
	...
	<script src="../labor/customervalidateupdate.js"></script>
