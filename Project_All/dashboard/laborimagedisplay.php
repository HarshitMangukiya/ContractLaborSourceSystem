									...
									<li>
										...
										<div class="collapse show" id="subnav2">
											<ul class="nav nav-collapse subnav">
												...
												<li class="active">
													<a href="laborimagedisplay.php">
														<span class="sub-item">Edit Labor Image Detail</span>
													</a>
												</li>
											</ul>
										</div>
				...
				<div class="page-inner">
					<div class="page-header">
						...
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="#">Edit Labor Image Detail</a>
							</li>
						</ul>
					</div>
					<div class="row">
							...
							<div class="card">
								<div class="card-header">
									<!-- <div class="d-flex align-items-center"> -->
										<h4 class="card-title">Labor Image Information</h4>
									...
									<div class="table-responsive">
										<table id="add-row" class="display table table-striped table-hover" >
											...
											<?php
												...
												if(isset($_REQUEST['laimid']))
												{
													$path1="../../../Labor/labor_img/";

														
														$qry1="select * from image where i_id=".$_REQUEST['laimid'];
														// echo $qry1;
														...
														$qry2="delete from image where i_id=".$_REQUEST['laimid'];
														// echo $qry2;
		      									  ...
		      									  echo "<script> window.location.href='laborimagedisplay.php';</script>";
												...
												{
													unset($_SESSION['imagelaborid']);
													$_SESSION['imagelaborid']=$_REQUEST['laid'];
												}

												if(isset($_SESSION['imagelaborid']))
												{	
												$qry="select * from image where i_laborid=".$_SESSION['imagelaborid'];
												...
												while($row=mysqli_fetch_row($res))
													...
													<td><a href="laborsingle.php?laid=<?php echo $row[0]; ?>"><?php echo $row[3];?></a></td>
													...
													<?php
														...
														{	
															...
															<img src="<?php echo $imagename; ?>" width="100px" height=100>
													<?php
														}
														else if($row[2]==2)
														{	
												...
												$go_to_address="https://www.youtube.com/embed/".$row[1];
							        	echo "<iframe SRC=\"".$go_to_address."\" width=\"100\" height=\"100\" framespacing=0 frameborder=no border=0 scrolling=auto style=\"border-radius:5px\"></iframe>";
							        					}
													?>
													</td>
													...
													<td>
														...
														<a href="laborimagedisplay.php?laimid=<?php echo $row[0]; ?>" class="btn btn-link btn-danger">	
