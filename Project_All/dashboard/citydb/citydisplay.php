												...
												while($row=mysqli_fetch_row($res))
													{
														...
														if(!empty($row[2]))
														{
														$qry1="select * from state where s_id=".$row[2];
...
<!-- 													<td><?php echo $row[4];?></td>
													...
													<td>
														<div class="form-button-action">
															<a href="cityedit.php?ciid=<?php echo $row[0]; ?>" class="btn btn-link btn-primary btn-lg">		
																<i class="fa fa-edit"></i>
															</a>
														</div></td>						
													<td>
														<div class="form-button-action">
														<a href="citydisplay.php?ciid=<?php echo $row[0]; ?>" class="btn btn-link btn-danger">	
