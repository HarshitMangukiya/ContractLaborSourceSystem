							...
							<div class="collapse show" id="submenu">
								<ul class="nav nav-collapse">
									...
									<li>
										...
										<div class="collapse show" id="subnav6">
											<ul class="nav nav-collapse subnav">
												<li>
													<a href="cityinsert.php">
														<span class="sub-item">Add New City</span>
													</a>
												</li>
												<li>
													<a href="citydisplay.php">
														<span class="sub-item">Edit City Detail</span>
													</a>
												</li>
												<li class="active">
													<a href="#">
														<span class="sub-item">Update City Detail</span>
													</a>
												</li>
											</ul>
										</div>
			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Update City Name</h4>
										...
										<div class="row">
											<div class="col-md-6 col-lg-4">
												...
												<div class="form-group">
													...
													<input type="text" class="form-control" id="firstname3" name="firstname" placeholder="Enter City name " value="<?php echo $firstname;?>" >
												    <span id="error_firstname3" class="text-danger"></span>
												</div>

									<div class="form-group">
									<labal for="password">State Name:</labal>
...
<!-- 
 ...
 -->
	...
	<script src="../labor/cityvalidate.js"></script>
