...
<form method="post" enctype="multipart/form-data">
									...
									<li>
										...
										<div class="collapse show" id="subnav2">
											<ul class="nav nav-collapse subnav">
												...
												<li class="active">
													<a href="labordisplay.php">
														<span class="sub-item">Update Labor Detail</span>
													</a>
												</li>
											</ul>
										</div>
			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Update Labor Information</h4>
	...
	<script src="./labor/laborvalidateupdate.js"></script>
