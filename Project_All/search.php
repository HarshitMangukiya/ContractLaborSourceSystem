				...
				<div class="container">
					<div class="row justify-content-center d-flex">
						...
						if(isset($_POST['search']))
						{
						    ...
						    if(!empty($searchname))
							{
								$qry .= " l_id='$searchname' or l_firstname='$searchname' or l_lastname='$searchname' or l_age='$searchname' or l_pincode='$searchname' or l_gender='$searchname' or l_email='$searchname' or l_phone='$searchname' or l_aadharno='$searchname' or l_location='$searchname' or l_status='$searchname' or l_charge='$searchname' or l_date='$searchname' or l_leaderid='$searchname'";
							}
							// echo $qry;
						...
						{	
							...
							{
							$qry="select * from labor where l_dflag<>'1' and l_state=".$_REQUEST['stateid'];
								// echo $qry;
							}
							else
							{
